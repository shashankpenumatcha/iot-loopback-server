  ...
  /*require('socketio-auth')(app.io, {
    ...
    app.io.on('connection', function(socket){
      ...
      socket.on('getSchedules', function(deviceId){
        try{
          log.info("get schedules for "+ deviceId);
          app.io.to(deviceId).emit('getSchedules',{socketId:socket.id, deviceId:deviceId});
        }catch(e){
          log.error("caught error while getting schedules")
          log.error(e)
          log.debug(deviceId)
        }
      });
      ...
      socket.on('getDeviceInfo',function(deviceId){
        try{
          ...
          Device.findOne({"where":{"deviceId":deviceId},"include":["boards"]},(err,device)=>{
            log.info('got device info from db '+device);
            if(device){
          ...
          log.error('error while getting device info')
          log.error(e);
          log.debug(deviceId)
        }
      });
      ...
      socket.on('getDeviceInfo2',function(deviceId){
        try{
          ...
          log.error('error while getting device info2')
          log.error(e);
          log.debug(deviceId)
        }
      });
      ...
      socket.on('getBoards',function(deviceId){
        try{
          ...
          log.error('error while getting boards')
          log.error(e);
          log.debug(deviceId)
        }
      });
        ...
        if(msg.socketId){
          if(!msg.error){
            ...
            try{
              ...
              log.error('error while sending location added confirmation')
              log.error(e);
              log.debug(msg)
            }
      ...
      socket.on('deleteSwitch',function(msg, callback){
        try{
          ...
          log.error('error while deleting switch')
          log.error(e);
          log.debug(msg)
        }
      });
      ...
      socket.on('editSwitch',function(msg, callback){
        try{
          ...
          log.error('error while editing switch')
          log.error(e);
          log.debug(msg)
        }
      });
      ...
      socket.on('editSwitchLogo',function(msg, callback){
        try{
          ...
          log.error('error while editing switch logo')
          log.error(e);
          log.debug(msg)
        }
      });
      ...
      socket.on('editLocationName',function(msg, callback){
        try{
          ...
          log.error('error while editing location name')
          log.error(e);
          log.debug(msg)
        }
      });
      ...
      socket.on('editLocationLogo',function(msg, callback){
        try{
          ...
          log.error('error while editing location logo')
          log.error(e);
          log.debug(msg)
        }
      });
      ...
      socket.on('addSwitches',function(msg, callback){
        try{
          ...
          log.error('error while adding switches')
          log.error(e);
          log.debug(msg)
        }
      });
            ...
            Device.findOne({"include":"user","where":{"deviceId":response.device}},function(err,device){
              if(!err){
                ...
                Device.sendMail(array,device.toJSON().user.email,days,response.week)
                  ...
                  log.info("send mail fail, no days")
                }
              }
            })
      ...
      socket.on('addBoard',function(msg, callback){
        try{
          ...
          log.error('error while adding board')
          log.error(e);
          log.debug(msg)
        }
      });
      ...
      socket.on('addSchedule',function(msg, callback){
        try{
          ...
          log.error('error while adding schedule')
          log.error(e);
          log.debug(msg)
        }
      });
      ...
      socket.on('editSchedule',function(msg, callback){
        try{
          ...
          if(payload && payload.error){
            ...
            const scheduleId = uuid();
            devices.map(m => {
              log.info(`add schedule request sent to device ${m}`)
          ...
          log.error('error while editing schedules')
          log.error(e);
          log.debug(msg)
        }
      });
      ...
      socket.on('toggleSchedule', payload => {
        log.info('request to toggle schedule')
      ...
      socket.on('deleteSchedule', payload => {
        log.info('request to delete schedule')
        log.info(payload)
        payload.socketId=socket.id;
