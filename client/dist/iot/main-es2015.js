...
/* harmony import */ var _app_config_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./app.config.js */ "./src/app/app.config.js");
...
const config = { url: _app_config_js__WEBPACK_IMPORTED_MODULE_14__["Config"].server, options: {} };
...
let LoginComponent = class LoginComponent {
    constructor(fetchData, router, dataService) {
        this.fetchData = fetchData;
        this.router = router;
        this.dataService = dataService;
    }
