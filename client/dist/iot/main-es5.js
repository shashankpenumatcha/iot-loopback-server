...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppToolbarToolbarComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<div *ngIf=\"selected\" style=\"position:fixed;bottom:0px;right:0px;background:#222831;height: 80px;width:100%;\">\n  <div class=\"container\">\n    <div style=\"color: #fff;\n    padding-top: 20px;\" class=\"row\">\n      <div [routerLink]=\"['/']\" [ngClass]=\"{'selected':selected=='Home'}\" class=\"col-3\">Home</div>\n      <div [ngClass]=\"{'selected':selected=='Usage'}\" class=\"col-3\">Usage</div>\n      <div [routerLink]=\"['/schedules']\" [ngClass]=\"{'selected':selected=='Schedules'}\" class=\"col-3\">Schedules</div>\n      <div [ngClass]=\"{'selected':selected=='Settings'}\" class=\"col-3\">Settings</div>\n    </div>\n  </div>\n</div>\n";
    /***/
  },
      ...
      _createClass(ScheduleComponent, [{
        ...
        value: function launch() {
          ...
          if (this.deviceLength) {
            ...
            modalRef.result.then(function (res) {
              var devices = Object.keys(_this16.onlineDevices);
              devices.map(function (m) {
                _this16.socket.emit('getSchedules', m);
        ...
        value: function toggleActive(schedule, devices) {
          ...
          if (deviceKeys && deviceKeys.length) {
            deviceKeys.map(function (device) {
              _this17.activeRequests[schedule.scheduleId].push(device);
              ...
              _this17.socket.emit('toggleSchedule', payload);
        ...
        value: function deleteSchedule(schedule, devices) {
          ...
          if (deviceKeys && deviceKeys.length) {
            this.schedules = {};
            deviceKeys.map(function (device) {
              _this18.deleteRequests[schedule.scheduleId].push(device);

              var payload = {};
              payload.scheduleId = schedule.scheduleId;
              payload.deviceId = device;

              _this18.socket.emit('deleteSchedule', payload);
      ...
      _createClass(SignUpComponent, [{
        ...
        value: function signup() {
          ...
          this.fetchData.signup(payload).subscribe(function (res) {
            ...
            console.log(res);
            _this19.username = null;
            _this19.email = null;
            _this19.password = null;
            _this19.terms = true;
            ...
            if (e && e.details && e.details.messages && Object.keys(e.details.messages)) {
              ...
              if (m.length) {
                return _this19.error = e.details.messages[m[0]];
              }
            }

            console.log(err);
            return _this19.error = 'signup failed';
          });
        }
      }]);
